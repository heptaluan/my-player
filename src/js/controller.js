...
class Controller {
    ...
    initOrderButton() {
        this.player.template.order.addEventListener('click', () => {
            if (this.player.options.order === 'list') {
                ...
                document.querySelector('.aplayer-icon-order').title = "随机播放"
                ...
                document.querySelector('.aplayer-icon-order').title = "顺序播放"
            }
        });
    }
    ...
    initClearButton() {
        this.player.template.delButton.addEventListener('click', () => {
    ...
    initUploadFile() {
        ...
        document.getElementById('fileInput').addEventListener('change', function (event) {
            ...
            that.player.events.trigger('addNewFile', {
                files: files
            });
            setTimeout(() => {
                event.target.value = ''
